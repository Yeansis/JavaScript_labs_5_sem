/* 8. Существует два массива с индивидуальными значениями.
Напишите программу для вычисления суммы каждых отдельных значений
индекса из заданных массивов (массивы могут быть разной размерности) */
...
function fold_el_arr(a, b, n) {
    ...
    if (n + 1 > a_len && (a_len === b_len || n + 1 > b_len)) {
        throw new Error("Заданного индекса нет ни в одном массиве!");
    }
    ...
    if (a_len !== b_len && ( n + 1 > a_len || n + 1 > b_len)) {
        if (a_len > b_len) {
            throw new Error("Массивы разной размерности. " +
